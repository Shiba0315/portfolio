      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            A comprehensive list of the tools, software, and hardware I use
            daily for development, design, and productivity.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                My primary development machine with 16GB RAM and 512GB SSD. The
                M1 chip provides incredible performance for all my development
                tasks.
              </p>
              <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                <span className="bg-teal-100 dark:bg-teal-900 text-teal-800 dark:text-teal-200 px-2 py-1 rounded-full">
                  Primary
                </span>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                External monitor for additional screen real estate. Perfect for
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Wireless mechanical keyboard with brown switches. Great tactile
                feedback for long coding sessions.
              </p>
              <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Ergonomic wireless mouse with customizable buttons. Perfect for
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                My primary code editor with extensions like Prettier, ESLint,
                and GitLens for enhanced productivity.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Version control and collaboration platform. I use GitHub for all
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                API testing and development tool. Essential for backend
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Containerization platform for consistent development
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Primary design tool for UI/UX design, prototyping, and
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Photoshop and Illustrator for advanced image editing and vector
                graphics creation.
              </p>
              <div className="flex flex-wrap gap-2">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Team communication and collaboration platform for project
                coordination.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-2 py-1 rounded-full text-sm">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Kanban board for task management and project tracking.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-2 py-1 rounded-full text-sm">
                  Project Management
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Music streaming for focus and productivity during coding
                sessions.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-2 py-1 rounded-full text-sm">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Essential for debugging React applications and inspecting
                component state.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-2 py-1 rounded-full text-sm">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Automatically applies dark mode to websites that don&apos;t have
                it built-in.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-2 py-1 rounded-full text-sm">
